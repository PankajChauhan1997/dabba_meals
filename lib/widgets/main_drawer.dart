...
class MainDrawer extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Drawer(child:Column(children:[
      DrawerHeader(decoration:BoxDecoration(gradient:LinearGradient(colors: [
        Theme.of(context).colorScheme.onSurface,
        Theme.of(context).colorScheme.onSurface.withOpacity(0.1),
      ],begin:Alignment.topLeft,end:Alignment.bottomRight)),
        padding:EdgeInsets.all(20),child:Row(children:[
          Icon(Icons.fastfood,color:Theme.of(context).colorScheme.onSurface),
          SizedBox(width:18),
          Text('Cooking up!',
